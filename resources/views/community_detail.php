				...
				<div class="content">
					<div class="top">
						...
						<?php if ($logined && $data->account_idx == $_SESSION['idx']) :?>
							<p align="right">
								<button type="button" class="cm_btn" onclick="iModifyComm()">수정</button>
								<button type="button" class="cm_btn" onclick="deleteComm">삭제</button>
							</p>
						<?php endif;?>
						...
						<div class="reply_write">
							...
							<table class="reply_write_table">
								...
								<?php if ($logined)	:?>
									...
									<td class="reply_write_td" width="150px"><button type="button" onclick="writeReply();">등록</button></td>
								<?php else :?>
									...
									<td class="reply_write_td" width="150px"><button type="button" onclick="alert('로그인 후에 이용해주세요.');">등록</button></td>
								<?php endif;?>
								</tr>
							</table>
						</div>
