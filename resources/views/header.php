<div class="header_wrap">
	<div class="menu">
		...
		<div class="pc_header">
			<a onclick="toggleCateSelector()"><div class="menu_item96 f_l dropdown_menu">맛지도&nbsp;<i class="fa fa-caret-down" aria-hidden="true"></i></div></a>
			<a href="<?=$adr_ctr?>Community/index"><div class="menu_item96 f_l">커뮤니티</div></a>
		</div>
		<div class="m_header">
